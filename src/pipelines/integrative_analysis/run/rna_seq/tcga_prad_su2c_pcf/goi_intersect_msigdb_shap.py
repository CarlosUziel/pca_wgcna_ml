...
from pipelines.integrative_analysis.utils import intersect_msigdb_shap
...
if __name__ == "__main__":
    ...
    if PARALLEL and len(input_collection) > 1:
        parallelize_map(
            functools.partial(run_func_dict, func=intersect_msigdb_shap),
            input_collection,
            threads=user_args["threads"],
        )
    else:
        for ins in tqdm(input_collection):
            intersect_msigdb_shap(**ins)
