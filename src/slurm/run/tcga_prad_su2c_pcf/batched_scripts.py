...
GOI_BATCHES: Dict[str, Iterable[Path]] = {
    "goi_rna_functional_analysis": (
        ...
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_pathways.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_pathways_genes.py"),
    ),
    "goi_rna_ml_genes": (
        SRC_ROOT.joinpath("pipelines")
        .joinpath("ml_classifiers")
        ...
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_genes_features_hptuning.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("ml_classifiers")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_genes_features_bootstrap_training.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_degs.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_degs_external.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_degs_shap.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_pathways_genes_shap.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_wgcna_shap.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("functional_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
    ...
    "goi_rna_ml_gene_sets": (
        SRC_ROOT.joinpath("pipelines")
        .joinpath("ml_classifiers")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_gene_sets_features_hptuning.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("ml_classifiers")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_gene_sets_features_bootstrap_training.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_msigdb_shap.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("integrative_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_msigdb_shap_genes.py"),
    ),
    "goi_rna_wgcna": (
        SRC_ROOT.joinpath("pipelines")
        .joinpath("wgcna")
        ...
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_intersect_wgcna.py"),
        SRC_ROOT.joinpath("pipelines")
        .joinpath("functional_analysis")
        .joinpath("run")
        .joinpath("rna_seq")
        .joinpath("tcga_prad_su2c_pcf")
        .joinpath("goi_wgcna.py"),
    ),
    "goi_meth": (
        SRC_ROOT.joinpath("pipelines")
        .joinpath("differential_methylation")
...
submit_batches(
    batches={**CONTRASTS_BATCHES, **GOI_BATCHES},
    src_path=SRC_ROOT,
    logs_path=LOGS_PATH,
